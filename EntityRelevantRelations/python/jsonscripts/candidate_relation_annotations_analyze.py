            ...
            for item in json_decode:
                ...
                for relation in item['relAnnotations']:
                    ...
                    if len(sub_ann) > 0 and len(obj_ann) > 0:
                        ...
                        all_relevant_relations.add(relation['relation'])
                        ...
                        if sub_intersection_set_len >0 and obj_intersection_set_len > 0:
                            ...
                            both_relevant_relations.add(relation['relation'])
                ...
                if query_id in output_json:
                    ...
                    output_json[query_id]['all_relevant_relations_list'] = output_json[query_id]['all_relevant_relations_list'] + '\n'.join(list(all_relevant_relations))
                    output_json[query_id]['both_relevant_relations_list'] = output_json[query_id]['both_relevant_relations_list'] + '\n'.join(list(both_relevant_relations))
                else:
                    item_json = dict()
                    ...
                    item_json['all_relevant_relations_list'] = '\n'.join(list(all_relevant_relations))
                    item_json['both_relevant_relations_list'] = '\n'.join(list(both_relevant_relations))
