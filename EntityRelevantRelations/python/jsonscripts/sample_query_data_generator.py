...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Please provide input jsonl file, output jsonl file location and query")
    parser.add_argument('--r', help='input jsonl location')
    parser.add_argument('--o', help='output jsonl file location')
