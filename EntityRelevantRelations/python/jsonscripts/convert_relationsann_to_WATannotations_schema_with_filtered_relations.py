...
def convert_relation_annotations_to_wat_annotations_schema_with_flitered_relations(input_file, output_file):
    ...
    for item in input_json:
        ...
        for rel in item['relAnnotations']:
            ...
            if sub_counter > 0 and obj_counter > 0:
                for sub in rel['subjectAnnotations']:
                    for entityid in sub['wiki_converted_id']:
                        rel_annotations.append(entityid)
                for obj in rel['objectAnnotations']:
...
if __name__ == "__main__":
    ...
    convert_relation_annotations_to_wat_annotations_schema_with_flitered_relations(args.i, args.o)
