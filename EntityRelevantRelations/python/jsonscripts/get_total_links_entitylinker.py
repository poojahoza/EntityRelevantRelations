...
def find_common_entities(json_dict, qrel_dict):
    ...
    for query,ent in qrel_dict.items():
        if query in json_dict:
            ...
            common_entities_dict['total_entitylink_entities'] = len(json_dict[query])
            ...
            common_entities_dict['common_entities_out_of_total_entitylink'] = len(ent - json_dict[query])/len(json_dict[query])
