...
public class EntityIndexReader {
    ...
    //Takes index location as input
    public EntityIndexReader(String indexLoc) throws IOException{
        //takes the path of index and opens the index through IndexReader
        ...
        if(DBSettings.mongoClient == null){
            ...
            //assumes an empty entityIndex collection to be present in test DB
